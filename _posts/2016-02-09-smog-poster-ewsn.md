...
Centralised routing protocols have been proposed in WSNs by some standards and protocols, such as WirelessHART and Hydro. However, these protocols have some limitations. For instance, WirelessHART is not open and has limited scalability according to [1]. On the other hand, [Hydro](http://www.cs.berkeley.edu/~stevedh/pubs/smartgrid10hydro.pdf) builds an incomplete network topology model, which limits the network-wide decisions that can be taken.
